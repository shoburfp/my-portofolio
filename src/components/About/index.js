            ...
            <div className="container">
                <div className="flex flex-wrap">
                    <div className="w-full mb-10 lg:w-1/2">
                        ...
                        <h2 className="font-bold text-secondary text-3xl mb-5 max-w-md lg:text-4xl">
                            Kenali saya lebih lanjut
                        </h2>
                        <p className="font-medium text-base text-slate-500 max-w-xl">
                    ...
                    <div className="w-full lg:px-14 lg:w-1/2 lg:right-0">
                        ...
                        <p className="font-medium text-base text-slate-500 mb-6">Lorem ipsum dolor sit amet consectetur adipisicing
